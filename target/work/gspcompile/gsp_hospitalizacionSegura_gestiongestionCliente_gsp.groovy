...
class gsp_hospitalizacionSegura_gestiongestionCliente_gsp extends GroovyPage {
...
expressionOut.print(cliente.nombre)
printHtmlPart(48)
invokeTag('textField','g',357,['class':("form-control"),'id':("emailPersonalGestion"),'name':("emailPersonalGestion"),'value':(cliente.email)],-1)
printHtmlPart(49)
invokeTag('textField','g',361,['class':("form-control"),'id':("lugarNacimiento"),'name':("lugarNacimiento"),'value':("")],-1)
printHtmlPart(50)
invokeTag('textField','g',367,['class':("datepicker form-control"),'id':("fechaNacimientoGestion"),'name':("fechaNacimientoGestion"),'value':(cliente.fecha_nacimiento),'onkeypress':("return soloLetras(event)")],-1)
printHtmlPart(51)
invokeTag('select','g',372,['class':("form-control"),'id':("gestionLinea"),'name':("gestionLinea"),'optionKey':("key"),'optionValue':("value"),'from':(['SI':'SI','NO':'NO']),'noSelection':(['': '-- Seleccione --'])],-1)
printHtmlPart(52)
invokeTag('textField','g',377,['class':("form-control"),'id':("codigoOtp"),'name':("codigoOtp"),'value':("")],-1)
printHtmlPart(53)
invokeTag('select','g',382,['class':("form-control"),'id':("tipoPlanGestion"),'name':("tipoPlanGestion"),'optionKey':("key"),'optionValue':("value"),'from':(['PLAN A':'PLAN A','PLAN B':'PLAN B','PLAN C':'PLAN C']),'noSelection':(['': '-- Seleccione --'])],-1)
printHtmlPart(54)
invokeTag('select','g',387,['class':("form-control"),'id':("estado_civil"),'name':("estado_civil"),'from':(['SOLTERO', 'CASADO', 'DIVORCIADO', 'VIUDO', 'UNION LIBRE', 'CONCUBINATO', 'CASADO SEPAR. BIENES']),'noSelection':(['': '-- Seleccione --']),'optionValue':("value")],-1)
printHtmlPart(55)
invokeTag('select','g',392,['class':("form-control"),'id':("generoGestion"),'name':("generoGestion"),'optionValue':("value"),'optionKey':("key"),'from':(['MASCULINO' :'MASCULINO', 'FEMENINO': 'FEMENINO']),'noSelection':(['': '-- Seleccione --'])],-1)
printHtmlPart(56)
invokeTag('textArea','g',397,['class':("form-control"),'id':("observacionesGestion"),'name':("observacionesGestion"),'value':(cliente.observaciones)],-1)
printHtmlPart(57)
})
invokeTag('form','g',403,['action':("guardarCliente"),'id':("idFormPDF"),'name':("idFormPDF")],1)
printHtmlPart(58)
invokeTag('select','g',422,['class':("form-control"),'name':("producto"),'from':(['Negocio Protegido PYME-Estructura', 'Negocio Protegido PYME-Contenido']),'noSelection':(['': '-- Seleccione --'])],-1)
printHtmlPart(59)
invokeTag('select','g',428,['class':("form-control"),'id':("plan"),'name':("plan"),'optionKey':("nombre"),'noSelection':(['': '-- Seleccione --']),'from':("")],-1)
printHtmlPart(60)
invokeTag('javascript','asset',445,['src':("usogeneral/objetos.js")],-1)
printHtmlPart(0)
invokeTag('javascript','asset',446,['src':("gestion/gestionCliente1.js")],-1)
printHtmlPart(0)
invokeTag('stylesheet','asset',447,['src':("usogeneral/datetimepicker.css")],-1)
printHtmlPart(0)
invokeTag('javascript','asset',451,['src':("usogeneral/datetimepicker.js")],-1)
printHtmlPart(0)
invokeTag('javascript','asset',452,['src':("usogeneral/customdatetimepicker.js")],-1)
printHtmlPart(0)
invokeTag('javascript','asset',453,['src':("usogeneral/bootstrap-datepicker.min.js")],-1)
printHtmlPart(0)
invokeTag('javascript','asset',454,['src':("usogeneral/customdatepicker.js")],-1)
printHtmlPart(0)
invokeTag('javascript','asset',456,['src':("usogeneral/bootstrap-datepicker.es.min.js")],-1)
}
...
public static final long LAST_MODIFIED = 1629212181832L
