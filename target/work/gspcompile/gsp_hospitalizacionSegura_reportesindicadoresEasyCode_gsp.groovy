...
class gsp_hospitalizacionSegura_reportesindicadoresEasyCode_gsp extends GroovyPage {
...
printHtmlPart(9)
for( _it609965887 in (tablaResult) ) {
changeItVariable(_it609965887)
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1560366632012L
